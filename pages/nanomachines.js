...
import useNanomachines from "../hooks/useNanomachines";
import useMasterchef from "../hooks/useMasterchef";
>>>>>>> a4586d7b3865b8b8bf990fc1b49027e6d8dfb89d
...
>>>>>>> a4586d7b3865b8b8bf990fc1b49027e6d8dfb89d
    ...
    const renderStats = useCallback(
        () => (
            <Spin spinning={loading}>
                <Card
                    title="Nanomachine Production Facilty"
                    extra={
                ...
                >
                    <Row gutter={[20, 20]}>
                        <Col span={8}>
                            <Statistic
                                title="Nanomachines in Existence"
                                value={web3.utils.fromWei(
                                    nanomachinesupply.toString()
                                )}
                            />
                        </Col>
                        <Col span={8}>
                            <Statistic
                                title="Nanomachines Manufactured per Block"
                                value={web3.utils.fromWei(
                                    nanoproduction.toString()
                                )}
                            />
                        </Col>
                        <Col span={8}>
                            <Statistic
                                title="Nanomachines Manufactured Per Day"
                                value={web3.utils.fromWei(
                                    dailyproduction.toString()
                                )}
                            />
                        </Col>
                    </Row>

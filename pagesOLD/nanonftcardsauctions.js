...
import AuctionList from '../forms/AuctionList'
...
import NanoNFTInventory from '../forms/NanoNFTInventory'
  ...
  return (
    <PublicLayout>
      <div style={{ padding: `20px 0px` }}>
        <Title level={2}>NFT NANO Management Console</Title>
          ...
          (state.hasSecurity && wallet.status == 'connected') && (
            <div>
              ...
              <Tabs defaultActiveKey="dashboard" style={{ marginTop: 20 }}>
                <Tabs.TabPane tab="Auction  Dashboard" key="dashboard">
				 ...
				 <Tabs.TabPane tab="Nano NFT Portfolio" key="details">
                  <NanoNFTInventory />
                </Tabs.TabPane>
                <Tabs.TabPane tab="Nano NFT Auction Statistics" key="details">
                  { renderStats() }
                </Tabs.TabPane>

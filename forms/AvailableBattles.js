          ...
          <Collapse.Panel header={`${warbotid} -${warbotlevel} -${type}`}>
            <Row style={{ marginTop: 10 }} gutter={[20, 20]}>
              <Col span={24}>
			   ...
			   <Button type="primary" onClick={() => joinWar(id)}  style={{ background: "black", borderColor: "yellow" }}>Join War</Button>
			   <Button type="primary" onClick={() => startWar(id)}  style={{ background: "black", borderColor: "yellow" }}>Start War</Button>
